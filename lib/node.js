...
var UPDATE_INTERVAL = (process.env.UPDATE_INTERVAL || 1500);
...
var url = "https://"+process.env.API_HOST+"/api?module=gastracker&action=gasoracle&apikey=" + process.env.API_KEY;
